...
export default function CuerposTaxidermicosPage() {
  const project = projects.find(p => p.slug === 'cuerpos-taxidermicos');
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex flex-col md:flex-row min-h-screen">
        ...
        {/* IZQUIERDA: FOTO 1 (25%) */}
        <div className="w-full md:w-1/4 bg-white relative flex items-center justify-center ">
